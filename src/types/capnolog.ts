...
// Een oefensessie telt pas mee vanaf deze duur (P9, UI-doorlichting B4):
// rust plus het grootste deel van gepaced ademen. Geldt overal waar CART-
// sessies geteld of gemiddeld worden: dagteller, week- en maandgemiddelde,
// referentieband, evolutie en compensatiedetectie. Twee losse waarden halen
// het niet.
export const MIN_CART_SESSION_SEC = 10 * 60;
